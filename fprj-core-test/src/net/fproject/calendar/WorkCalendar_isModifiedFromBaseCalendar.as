package net.fproject.calendar
{
	 ...
	 * <code>public function isModifiedFromBaseCalendar():Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isModifiedFromBaseCalendar
	{
		...
		{
			var returnTestValue:Boolean = workcalendar.isModifiedFromBaseCalendar();
