package net.fproject.calendar
{
	 ...
	 * <code>public function getWorkShiftsAtWeekDay(wd:int):Vector.<WorkShift></code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_getWorkShiftsAtWeekDay
	{
		...
		{
			var wd:int = 0;
			var returnTestValue:Vector.<WorkShift> = workcalendar.getWorkShiftsAtWeekDay(wd);
