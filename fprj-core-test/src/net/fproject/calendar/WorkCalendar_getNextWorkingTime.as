package net.fproject.calendar
{
	 ...
	 * <code>public function getNextWorkingTime(time:Date):Date</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_getNextWorkingTime
	{
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Date = workcalendar.getNextWorkingTime(time);
