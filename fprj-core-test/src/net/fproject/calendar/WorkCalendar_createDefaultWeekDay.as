package net.fproject.calendar
{
	 ...
	 * <code>internal function createDefaultWeekDay(wd:int):WeekDayInternal</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_createDefaultWeekDay
	{
		...
		{
			var wd:int = 0;
			var returnTestValue:WeekDayInternal = workcalendar.createDefaultWeekDay(wd);
