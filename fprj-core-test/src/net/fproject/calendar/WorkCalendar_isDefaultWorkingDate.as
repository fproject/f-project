package net.fproject.calendar
{
	 ...
	 * <code>public function isDefaultWorkingDate(date:Date):Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isDefaultWorkingDate
	{
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Boolean = workcalendar.isDefaultWorkingDate(date);
