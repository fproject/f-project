package net.fproject.calendar
{
	 ...
	 * <code>public function getTotalWorkAtDay(d:Date):Number</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_getTotalWorkAtDay
	{
		...
		{
			var d:Date = new Date();
			var returnTestValue:Number = workcalendar.getTotalWorkAtDay(d);
		...
		[Test (description="Boundary case: [d = null]")]
		/**
