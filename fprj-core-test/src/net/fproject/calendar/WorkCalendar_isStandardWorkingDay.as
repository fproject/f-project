package net.fproject.calendar
{
	 ...
	 * <code>public function isStandardWorkingDay(wd:int):Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isStandardWorkingDay
	{
		...
		{
			var wd:int = 0;
			var returnTestValue:Boolean = workcalendar.isStandardWorkingDay(wd);
