package net.fproject.calendar
{
	 ...
	 * <code>public function isWorkingDate(date:Date):Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isWorkingDate
	{
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Boolean = workcalendar.isWorkingDate(date);
