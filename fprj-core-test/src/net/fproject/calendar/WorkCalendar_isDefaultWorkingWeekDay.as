package net.fproject.calendar
{
	 ...
	 * <code>public function isDefaultWorkingWeekDay(wd:int):Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isDefaultWorkingWeekDay
	{
		...
		{
			var wd:int = 0;
			var returnTestValue:Boolean = workcalendar.isDefaultWorkingWeekDay(wd);
