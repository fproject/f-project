package net.fproject.calendar
{
	 ...
	 * <code>public function set baseCalendar(value:WorkCalendar):void</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_set_baseCalendar
	{
		...
		[Test (description="Normal case: [value = new WorkCalendar()]")]
		/**
		 * Test Case Type: Normal<br/>
		 * <br/>
		 * INPUT VALUES:<br/>
		 * <code>value = new WorkCalendar()</code><br/>
		 * <br/>
		 * OUTPUT EXPECTED:<br/>
		 * ---- expectations ----
		 *
		...
		{
			var value:WorkCalendar = new WorkCalendar();
			workcalendar.baseCalendar = new WorkCalendar();
