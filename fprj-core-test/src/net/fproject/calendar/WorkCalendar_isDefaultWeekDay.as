package net.fproject.calendar
{
	 ...
	 * <code>public function isDefaultWeekDay(wd:int):Boolean</code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_isDefaultWeekDay
	{
		...
		{
			var wd:int = 0;
			var returnTestValue:Boolean = workcalendar.isDefaultWeekDay(wd);
