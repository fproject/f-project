package net.fproject.calendar
{
	 ...
	 * <code>public function getWorkShiftsAt(date:Date):Vector.<WorkShift></code><br/>
	 * of class<br/>
	 * net.fproject.calendar.WorkCalendar
	 */
	public class WorkCalendar_getWorkShiftsAt
	{
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Vector.<WorkShift> = workcalendar.getWorkShiftsAt(date);
