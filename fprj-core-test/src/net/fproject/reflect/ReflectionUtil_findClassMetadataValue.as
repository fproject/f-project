package net.fproject.reflect
{
	...
	import testdata.di.ReflectionUtil_findMemberMetadataValue_001;
	import testdata.di.ReflectionUtil_findMemberMetadataValue_037;

	public class ReflectionUtil_findClassMetadataValue
	{		
		[Before]
		...
		{
			var container:ReflectionUtil_findMemberMetadataValue_001 = new ReflectionUtil_findMemberMetadataValue_001();
			var member:Label = container.label;
			var metadataName:String = "Abc";
			var argumentName:String = "a";
			var returnTestValue:Object = ReflectionUtil.findMemberMetadataValue(
				ReflectionUtil_findMemberMetadataValue_001, member, metadataName, argumentName);
		...
		public function testCase002():void
		{
			...
			var returnTestValue:Object = ReflectionUtil.findMemberMetadataValue(
				ReflectionUtil_findMemberMetadataValue_001, 'label', metadataName, argumentName);
			//---- Place result assertion here ----
			// You must replace this code by function specifications or 
			// the test always returns false!
		...
		public function testCase003():void
		{
			...
			var returnTestValue:Object = ReflectionUtil.findMemberMetadataValue(clazz, member, metadataName, argumentName);
			//---- Place result assertion here ----
			// You must replace this code by function specifications or 
			// the test always returns false!
			//-------------------------------------
		...
		public function testCase037():void
		{
			...
			var argumentName:String = "a";
			var returnTestValue:Object = ReflectionUtil.findMemberMetadataValue(
				ReflectionUtil_findMemberMetadataValue_037, member, metadataName, argumentName);
			//---- Place result assertion here ----
			// You must replace this code by function specifications or 
			// the test always returns false!
			assertTrue(returnTestValue == "a");
