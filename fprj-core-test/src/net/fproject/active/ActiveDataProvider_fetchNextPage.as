package net.fproject.active
{
	 ...
	 */
	public class ActiveDataProvider_fetchNextPage extends ServiceTestCaseBase
	{
		...
		public function testCase001_checkResult(event:ResultEvent, passThroughData:Object):void
		{
			...
			var resp:ActiveCallResponder = activedataProvider.fetchNextPage();
			resp.token.addResponder(Async.asyncResponder(this, new TestResponder(testCase001_checkResult2nd, onFault), 2000));
		}
		
		public function testCase001_checkResult2nd(event:ResultEvent, passThroughData:Object):void
		{
			checkResult(event, passThroughData, 2);
		}
