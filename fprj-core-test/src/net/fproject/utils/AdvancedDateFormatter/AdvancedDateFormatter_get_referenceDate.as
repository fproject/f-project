package net.fproject.utils.AdvancedDateFormatter
{
	 ...
	 * <code>public function get referenceDate():Date</code><br/>
	 * of class<br/>
	 * net.fproject.utils.AdvancedDateFormatter
	 */
	public class AdvancedDateFormatter_get_referenceDate
	{
		...
		{
			var returnTestValue:Date = advanceddateformatter.referenceDate;
