package net.fproject.utils.AdvancedDateFormatter
{
	 ...
	 * <code>public function set referenceDate(value:Date):void</code><br/>
	 * of class<br/>
	 * net.fproject.utils.AdvancedDateFormatter
	 */
	public class AdvancedDateFormatter_set_referenceDate
	{
		...
		public function testCase001():void
		{
			...
			advanceddateformatter.referenceDate = new Date();
		...
		{
			var value:Date = null;
			advanceddateformatter.referenceDate = null;
			//---- Place result assertion here ----
			// You must replace this code by function specifications or 
			// the test always returns false!
			assertFalse(true);
