package net.fproject.utils.AdvancedDateFormatter
{
	 ...
	 * <code>public function get startOfYear():Date</code><br/>
	 * of class<br/>
	 * net.fproject.utils.AdvancedDateFormatter
	 */
	public class AdvancedDateFormatter_get_startOfYear
	{
		...
		{
			var returnTestValue:Date = advanceddateformatter.startOfYear;
