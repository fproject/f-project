package net.fproject.utils.AdvancedDateFormatter
{
	 ...
	 * <code>public function set startOfYear(value:Date):void</code><br/>
	 * of class<br/>
	 * net.fproject.utils.AdvancedDateFormatter
	 */
	public class AdvancedDateFormatter_set_startOfYear
	{
		...
		public function testCase001():void
		{
			...
			advanceddateformatter.startOfYear = new Date();
		...
		{
			var value:Date = null;
			advanceddateformatter.startOfYear = null;
			//---- Place result assertion here ----
			// You must replace this code by function specifications or 
			// the test always returns false!
			assertFalse(true);
