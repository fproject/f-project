package net.fproject.utils
{
	 ...
	 * <code>internal static function getEndOfDay(date:Date):Date</code><br/>
	 * of class<br/>
	 * net.fproject.utils.DateTimeUtil
	 */
	public class DateTimeUtil_getEndOfDay
	{
		[Before]
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Date = DateTimeUtil.getEndOfDay(date);
