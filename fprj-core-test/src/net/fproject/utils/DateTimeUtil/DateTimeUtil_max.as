package net.fproject.utils.DateTimeUtil
{
	 ...
	 * <code>internal static function max(date1:Date, date2:Date):Date</code><br/>
	 * of class<br/>
	 * net.fproject.utils.DateTimeUtil
	 */
	public class DateTimeUtil_max
	{
		[Before]
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Date = DateTimeUtil.max(date1, date2);
