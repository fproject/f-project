package net.fproject.utils
{
	 ...
	 * <code>internal static function getTimeOfDayInMillis(date:Date):Number</code><br/>
	 * of class<br/>
	 * net.fproject.utils.DateTimeUtil
	 */
	public class DateTimeUtil_getTimeOfDayInMillis
	{
		[Before]
		...
		public function testCase001():void
		{
			...
			var returnTestValue:Number = DateTimeUtil.getTimeOfDayInMillis(date);
