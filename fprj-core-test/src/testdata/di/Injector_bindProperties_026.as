package testdata.di
{
	...
	public class Injector_bindProperties_026 extends SkinnableContainer
	{
		[Bindable]
		public var object:Injector_bindProperties_026_Obj = 
			new Injector_bindProperties_026_Obj(
				{selectedUser: new TestUser({id:1,username:"Peter Pan"})});
		
		[SkinPart(required="true")]
		[PropertyBinding(sourceEvent="selectedUserChange", text="object.selectedUser.username@")]
		public var nameTextInput:TextInput;
		
		public function Injector_bindProperties_026()
		{
