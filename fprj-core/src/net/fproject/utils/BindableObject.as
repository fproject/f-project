...
package net.fproject.utils
{
	...
	[RemoteClass(alias="net.fproject.utils.BindableObject")]

	
	dynamic public class BindableObject extends Proxy
										...
										IPropertyChangeNotifier
	{
		 ...
		 */
		public function BindableObject(item:Object = null, uid:String = null,
									proxyDepth:int = -1)
		{
			super();
		 ...
		 *  @productversion Flex 3
		 */
		protected var proxyClass:Class = BindableObject;
		 ...
		 *  @productversion Flex 3
		 */
		internal function get type():QName
		{
			return _type;
		}
		 ...
		 *  @private
		 */
		internal function set type(value:QName):void
		{
			_type = value;
		}
		...
		override flash_proxy function getProperty(name:*):*
		{
			...
			if (result)
			{
				if (_proxyLevel == 0 || mx.utils.ObjectUtil.isSimple(result))
				{
					return result;
				}
				else
		 ...
		 *  @productversion Flex 3
		 */  
		internal function getComplexProperty(name:*, value:*):*
		{
		 ...
		 *  @productversion Flex 3
		 */
		public function setupPropertyList():void
		{
			...
			{
				propertyList = mx.utils.ObjectUtil.getClassInfo(_item, null, {includeReadOnly:true, uris:["*"]}).properties;
			}
		}
	}
